...
- `target.callable` for Python entrypoints.
- OTel/Phoenix trace capture for supported agent frameworks.
- Hosted model targets.
- Hosted model + tools targets for simple prompt-agent setups.
